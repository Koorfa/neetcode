...
attributes = "{} ({}) - Hunger: {}, Energy: {}"
print("Initial Attributes:", attributes.format(whiskers.name, whiskers.species, whiskers.hunger, whiskers.energy))
...
print("Modified Attributes:", attributes.format(whiskers.name, whiskers.species, whiskers.hunger, whiskers.energy))